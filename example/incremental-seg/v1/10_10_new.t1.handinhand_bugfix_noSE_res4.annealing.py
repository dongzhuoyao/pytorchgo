...
from model_handinhand import get_handinhand
...
def main():
    ...
    # Create network.
    handinhand_model = get_handinhand(teacher_class_num, student_class_num, annealing=True, get_anneal=get_anneal,netstyle=7)

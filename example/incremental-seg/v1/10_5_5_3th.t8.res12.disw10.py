...
DATA_LIST_PATH = '../datalist_nonoverlap/class10+5+5_3th/current_incremental_train.txt'
VAL_DATA_LIST_PATH = '../datalist_nonoverlap/class10+5+5_3th/current_incremental_val.txt'
TEST_DATA_LIST_PATH = '../datalist_nonoverlap/class10+5+5_3th/current_incremental_test.txt'
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'train_log/10_5_5_2th.t8.res12.disw10/love.pth'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    logger.info("test miou for old class = {}".format(np.mean(best_val_ious[1:teacher_class_num])))
    logger.info("test miou for new class = {}".format(np.mean(best_val_ious[teacher_class_num:])))
    ...
    logger.info("test miou for old class = {}".format(np.mean(test_ious[1:teacher_class_num])))

...
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res1.py --gpu 3 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res12.py --gpu 3 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res123.py --gpu 3 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res1234.py --gpu 3 

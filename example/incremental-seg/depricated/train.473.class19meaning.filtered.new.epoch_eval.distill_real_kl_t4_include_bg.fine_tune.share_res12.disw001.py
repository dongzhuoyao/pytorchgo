...
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res12.disw01.py --gpu 0 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res12.disw001.py --gpu 0 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res12.disw10.py --gpu 0 &&
python train.473.class19meaning.filtered.new.epoch_eval.distill_real_kl_t4_include_bg.fine_tune.share_res12.disw100.py --gpu 0 
"""
...
def main():
    ...
    if args.distill_loss == "kl":
        ...
        def distill_loss_fn(outputs, teacher_outputs, T=4):
            """
    ...
    for i_iter, batch in tqdm(enumerate(trainloader), total=len(trainloader), desc="training deeplab"):
        ...
        loss = seg_loss + 0.01*distill_loss

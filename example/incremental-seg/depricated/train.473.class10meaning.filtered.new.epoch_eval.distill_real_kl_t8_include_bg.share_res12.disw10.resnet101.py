...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'train_log/train.473.class10meaning.filtered.old.epoch_eval.resnet101/love.pth' #'http://download.pytorch.org/models/resnet50-19c8e357.pth'
...
def main():
    ...
    # Create network.
    teacher_model = Res101_Deeplab(num_classes=teacher_class_num)

    student_model = Res101_Deeplab(num_classes=student_class_num)

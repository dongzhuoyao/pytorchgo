...
from model import Res101_Deeplab
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'resnet101-5d3b4d8f.pth' #'http://download.pytorch.org/models/resnet50-19c8e357.pth'
...
def main():
    ...
    # Create network.
    model = Res101_Deeplab(num_classes=NUM_CLASSES)
...
if __name__ == '__main__':
    if args.test:
        ...
        student_model = Res101_Deeplab(num_classes=NUM_CLASSES)

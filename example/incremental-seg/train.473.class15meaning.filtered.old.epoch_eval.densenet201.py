...
DATA_LIST_PATH = 'datalist/class15+5/old/train_10582.txt'
VAL_DATA_LIST_PATH = 'datalist/class15+5/old/val_1449.txt'
NUM_CLASSES = 15+1
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'densenet201-c1103571.pth' #'http://download.pytorch.org/models/densenet121-a639ec97.pth'
...
def main():
    ...
    # Create network.
    model = densenet201(num_classes=NUM_CLASSES,pre_softmax_node=1920)

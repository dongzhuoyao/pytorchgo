...
DATA_LIST_PATH = 'datalist/class15_gradual/new20/train_10582.txt'
VAL_DATA_LIST_PATH = 'datalist/val_1449.txt'


teacher_class_num = 19+1
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'train_log/train.473.class15meaning.filtered.new.epoch_eval.distill_kl_t2_include_bg.share_res12.disw10.gradual19/love.pth' #'http://download.pytorch.org/models/resnet50-19c8e357.pth'

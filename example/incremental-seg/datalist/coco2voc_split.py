...
train_aug_path = "coco2voc_train.txt"
val_path = "coco2voc_val.txt"
pascal_root = "/home/hutao/dataset/incremental_seg/coco2voc"

image_format = os.path.join(pascal_root, '{}')
label_format = os.path.join(pascal_root, "label", "{}")

...
if __name__ == '__main__':
    ...
    if args.test:
        args.test_restore_from = "train_log/train.473.class10meaning.filtered.new.epoch_eval.distill_real_kl_t8_include_bg.share_res12.disw10/love.pth"
        from evaluate_incremental import do_eval
        ...
        student_model.eval()
        do_eval(model=student_model, restore_from=args.test_restore_from, data_dir=args.data_dir, data_list=VAL_DATA_LIST_PATH, num_classes=student_class_num, is_save = True)
    else:
        logger.auto_set_dir()
        main()

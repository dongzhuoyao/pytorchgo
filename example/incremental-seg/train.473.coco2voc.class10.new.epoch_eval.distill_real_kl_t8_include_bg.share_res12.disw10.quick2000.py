...
DATA_LIST_PATH = 'datalist/coco2voc_split_class10+10/new/coco2voc_split_train.txt'
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'train_log/train.473.coco2voc.class10.old.epoch_eval.quick2000/love.pth' #'http://download.pytorch.org/models/resnet50-19c8e357.pth'
...
def main():
    ...
    trainloader = data.DataLoader(VOCDataSet(args.data_dir, args.data_list, max_iters=args.num_steps * args.batch_size,
                                             ...
                                             label_transform=label_transform, augmentation=augmentation,img_prefix="image"),
    ...
    for i_iter, batch in tqdm(enumerate(trainloader), total=len(trainloader), desc="training deeplab"):
        ...
        if i_iter >= args.num_steps-1:
            ...
            student_model.eval()
            ious = do_eval_coco2voc(model=student_model, data_dir=args.data_dir, data_list=VAL_DATA_LIST_PATH,
                                    num_classes=student_class_num, quick_eval=quick_eval)

...
from myssd_multicontext import build_ssd
...
log_per_iter = 100
save_per_iter = 2000
train_data_split = "fold3_1shot_train"
val_data_split = "fold3_1shot_val"
gpu = '4'
quick_eval = 1e10
start_channels = 6
...
def train():
    ...
    few_shot_net = build_ssd(size=args.dim, num_classes=num_classes, start_channels=start_channels, fuse_conv4=False,fuse_conv5=True,fuse_conv45=False,fuse_conv345=False)

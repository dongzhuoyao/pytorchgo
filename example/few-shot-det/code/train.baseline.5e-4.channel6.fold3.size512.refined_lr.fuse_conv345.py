...
def train():
    ...
    few_shot_net = build_ssd(size=args.dim, num_classes=num_classes, start_channels=start_channels, fuse_conv4=False,fuse_conv5=False,fuse_conv45=False,fuse_conv345=True)

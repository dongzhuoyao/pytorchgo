...
def train():
    ...
    dataset = FewShotVOCDataset(name=train_data_split, image_size=(args.dim, args.dim), channel4=True)
...
def do_eval(few_shot_net):
    ...
    dataset = FewShotVOCDataset(name=val_data_split, image_size=(args.dim, args.dim), channel4=True)

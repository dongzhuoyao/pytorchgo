...
def Res_Deeplab(NoLabels=21, pretrained = False):
    ...
    if pretrained:
        ...
        saved_state_dict = torch.load('/home/hutao/data/models/pytorch/MS_DeepLab_resnet_pretrained_COCO_init.pth')

        logger.info("deeplabv2 weight keys: {}".format(saved_state_dict.keys()))
